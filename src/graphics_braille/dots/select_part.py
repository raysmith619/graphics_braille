...
from graphics_braille.select_fun import select_copy
from graphics_braille.select_error import SelectError
from graphics_braille.select_trace import SlTrace
from graphics_braille.active_check import ActiveCheck

from graphics_braille.dots.select_loc import SelectLoc
from graphics_braille.dots.select_centered_text import CenteredText
from graphics_braille.dots.select_position import SelectPosition
from graphics_braille.dots.select_size import SelectSize
from graphics_braille.dots.select_velocity import SelectVelocity
from graphics_braille.dots.select_rotation import SelectRotation
from graphics_braille.canvas_tracked import CanvasTracked    # For debugging
...
class SelectPart(object):
    ...
    def do_a_centered_file(self, file_path, ct, text=None):
        ...
        if image is None:
            ...
            msg = f"No file found: {file_path} abs_path:{abs_path}"
            SlTrace.lg(msg)
            ct.text = msg
