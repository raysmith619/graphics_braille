...
from graphics_braille.dots.select_part import color_to_fill
...
class SelectRegion(SelectPart):
    ...
    def display(self):
        ...
        ###self.display_clear()
        if SlTrace.trace("xregion_rect") and False:
        ...
        if SlTrace.trace("xregno") and False:   # TFD
            cx = (c1x+c3x)/2
            cy = (c1y+c3y)/2
    ...
    def get_rect(self, sz_type=None, enlarge=False):
        ...
        if SlTrace.trace("xregion_rect") and False:     # TFD - reduce print
